...
void initialize_surf_scaf_gdextension_types(ModuleInitializationLevel p_level) {
...
void uninitialize_surf_scaf_gdextension_types(
 ...
 */
GDExtensionBool GDE_EXPORT surf_scaf_extension_init(
		GDExtensionInterfaceGetProcAddress p_get_proc_address,
		GDExtensionClassLibraryPtr p_library,
		GDExtensionInitialization *r_initialization) {
	GDExtensionBinding::InitObject init_obj(
			p_get_proc_address, p_library, r_initialization);
	init_obj.register_initializer(initialize_surf_scaf_gdextension_types);
	init_obj.register_terminator(uninitialize_surf_scaf_gdextension_types);
